 ...
 */
	...
	$depts = !empty($mC['staff_module']['allowed_filters']['departments']) ? $mC['staff_module']['allowed_filters']['departments'] : '';
	$tags = !empty($mC['staff_module']['allowed_filters']['tags']) ? $mC['staff_module']['allowed_filters']['tags'] : '';
	...
	if( !empty($mC['staff_module']['allowed_filters']['departments']) ){
		...
		foreach( $mC['staff_module']['allowed_filters']['departments'] as $department ){
